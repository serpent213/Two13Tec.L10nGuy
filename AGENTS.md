...
- `./flow l10n:scan` / `./flow l10n:unused` (from repo root) exercise the commands against the Senegal fixtures; dry-run flags guard catalog mutations during development.
